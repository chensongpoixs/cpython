...
#redis = Redis(host='192.168.1.2',port=6379,db=0)
#
#
##from  redis import Redis
##r = Redis()
#
##set方法
#print(redis.set('nosql','redis'))
#print(redis.get('nosql'))
#
##getset方法，为存在的key关联新的value，并返回旧值
#print(redis.getset('nosql','mongodb'))
#
##mget返回多个key对应的value,
#print(redis.mget('qq','pp','yy','star'))
...
#pool = redis.ConnectionPool(host='192.168.1.2', port=6379)
